...
def get_home_code_email(user_email: str, imap_email: str, imap_password: str) -> str:
    mail = imaplib.IMAP4_SSL(os.getenv("IMAP_SERVER"), port=993)
                ...
                if status == "OK":
                    ...
                    for response in message:
                        ...
                        if isinstance(response, tuple):
                            ...
                            if ("¿Vas a actualizar tu Hogar de Disney+?".replace(" ", "") in new_subject):
...
def call_get_disney_home_code(user_email: str) -> str:
